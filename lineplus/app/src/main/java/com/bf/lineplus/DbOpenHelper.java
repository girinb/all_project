...
public class DbOpenHelper {
    ...
    // Insert DB
    public long insertColumn(String title, String contents, String iamges) {
        ContentValues values = new ContentValues();
        values.put(DataBases.CreateDB.TITLE, title);
        values.put(DataBases.CreateDB.CONTENTS, contents);
        values.put(DataBases.CreateDB.IMAGES, iamges);
        return mDB.insert(DataBases.CreateDB._TABLENAME, null, values);
    }

    // Update DB
    public boolean updateColumn(long id, String title, String contents, String iamges) {
        ContentValues values = new ContentValues();
        values.put(DataBases.CreateDB.TITLE, title);
        values.put(DataBases.CreateDB.CONTENTS, contents);
        values.put(DataBases.CreateDB.IMAGES, iamges);
